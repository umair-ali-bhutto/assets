...
<span class="token function">npm</span> org <span class="token function">rm</span> <span class="token operator">&lt;</span>orgname<span class="token operator">></span> <span class="token operator">&lt;</span>username<span class="token operator">></span>
<span class="token function">npm</span> org <span class="token function">ls</span> <span class="token operator">&lt;</span>orgname<span class="token operator">></span> <span class="token punctuation">[</span><span class="token operator">&lt;</span>username<span class="token operator">></span><span class="token punctuation">]</span></code></pre></div>
...
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash">$ <span class="token function">npm</span> org <span class="token builtin class-name">set</span> my-org @mx-smith</code></pre></div>
<p>Add a new admin to an org (or change a developer to an admin):</p>
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash">$ <span class="token function">npm</span> org <span class="token builtin class-name">set</span> my-org @mx-santos admin</code></pre></div>
<p>Remove a user from an org:</p>
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash">$ <span class="token function">npm</span> org <span class="token function">rm</span> my-org mx-santos</code></pre></div>
<p>List all users in an org:</p>
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash">$ <span class="token function">npm</span> org <span class="token function">ls</span> my-org</code></pre></div>
<p>List all users in JSON format:</p>
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash">$ <span class="token function">npm</span> org <span class="token function">ls</span> my-org --json</code></pre></div>
<p>See what role a user has in an org:</p>
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash">$ <span class="token function">npm</span> org <span class="token function">ls</span> my-org @mx-santos</code></pre></div>
...
<p>You can use the <code class="language-text">npm org</code> commands to manage and view users of an organization.
