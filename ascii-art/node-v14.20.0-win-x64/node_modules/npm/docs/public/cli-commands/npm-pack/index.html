...
current working directory as <code class="language-text">&lt;name&gt;-&lt;version&gt;.tgz</code>, and then write
...
<p>The <code class="language-text">--dry-run</code> argument will do everything that pack usually does without
