...
<p>If the <code class="language-text">--production</code> flag is specified or the <code class="language-text">NODE_ENV</code> environment
variable is set to <code class="language-text">production</code>, this command will remove the packages
specified in your <code class="language-text">devDependencies</code>. Setting <code class="language-text">--no-production</code> will
negate <code class="language-text">NODE_ENV</code> being set to <code class="language-text">production</code>.</p>
<p>If the <code class="language-text">--dry-run</code> flag is used then no changes will actually be made.</p>
<p>If the <code class="language-text">--json</code> flag is used then the changes <code class="language-text">npm prune</code> made (or would
have made with <code class="language-text">--dry-run</code>) are printed as a JSON object.</p>
...
this command with the <code class="language-text">--production</code> flag.</p>
