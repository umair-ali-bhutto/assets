...
package name is provided, it will search for a <code class="language-text">package.json</code> in
the current folder and use the <code class="language-text">name</code> property.</p>
