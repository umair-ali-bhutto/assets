...
<p>If <code class="language-text">--scope</code> is provided, this will find the credentials for the registry
...
<p>If specified, you will be logged out of the specified scope. See <a href="../../using-npm/npm-scope"><code class="language-text">scope</code></a>.</p>
