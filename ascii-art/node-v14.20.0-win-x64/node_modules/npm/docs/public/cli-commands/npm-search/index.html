...
aliases: s, se, <span class="token function">find</span></code></pre></div>
...
<p>Search the registry for packages matching the search terms. <code class="language-text">npm search</code>
...
<p>Additionally, using the <code class="language-text">--searchopts</code> and <code class="language-text">--searchexclude</code> options paired with
more search terms will respectively include and exclude further patterns. The
main difference between <code class="language-text">--searchopts</code> and the standard search terms is that the
former does not highlight results in the output and can be used for more
fine-grained filtering. Additionally, both of these can be added to <code class="language-text">.npmrc</code> for
default search filtering behavior.</p>
<p>Search also allows targeting of maintainers in search results, by prefixing
their npm username with <code class="language-text">=</code>.</p>
<p>If a term starts with <code class="language-text">/</code>, then it's interpreted as a regular expression and
supports standard JavaScript RegExp syntax. A trailing <code class="language-text">/</code> will be ignored in
this case. (Note that many regular expression characters must be escaped or
quoted in most shells.)</p>
<h3 id="a-note-on-caching" style="position:relative;"><a href="#a-note-on-caching" aria-label="a note on caching permalink" class="header-link-class before"><svg aria-hidden="true" height="20" version="1.1" viewBox="0 0 16 16" width="20"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>A Note on caching</h3>
...
<p>Used as <code class="language-text">--no-description</code>, disables search matching in package descriptions and
...
repository, <code class="language-text">npm search</code> will default to that registry when searching. Pass a
