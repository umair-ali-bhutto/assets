...
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash"><span class="token function">npm</span> deprecate my-thing@<span class="token string">"&lt; 0.2.3"</span> <span class="token string">"critical bug fixed in v0.2.3"</span></code></pre></div>
<p>Note that you must be the package owner to deprecate something.  See the
<code class="language-text">owner</code> and <code class="language-text">adduser</code> help topics.</p>
<p>To un-deprecate a package, specify an empty string (<code class="language-text">&quot;&quot;</code>) for the <code class="language-text">message</code>
