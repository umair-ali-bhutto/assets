...
<p>This command repurposes <code class="language-text">package-lock.json</code> into a publishable
<code class="language-text">npm-shrinkwrap.json</code> or simply creates a new one. The file created and updated
by this command will then take precedence over any other existing or future
<code class="language-text">package-lock.json</code> files. For a detailed explanation of the design and purpose
