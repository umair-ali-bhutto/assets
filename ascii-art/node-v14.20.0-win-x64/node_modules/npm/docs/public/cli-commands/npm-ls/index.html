...
aliases: list, la, ll</code></pre></div>
...
<p>Positional arguments are <code class="language-text">name@version-range</code> identifiers, which will
...
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash">    npm@6.14.17 /path/to/npm
...
<p>When run as <code class="language-text">ll</code> or <code class="language-text">la</code>, it shows extended information by default.</p>
...
<h4 id="prod--production" style="position:relative;"><a href="#prod--production" aria-label="prod  production permalink" class="header-link-class before"><svg aria-hidden="true" height="20" version="1.1" viewBox="0 0 16 16" width="20"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>prod / production</h4>
<ul>
<li>Type: Boolean</li>
<li>Default: false</li>
</ul>
<p>Display only the dependency tree for packages in <code class="language-text">dependencies</code>.</p>
<h4 id="dev--development" style="position:relative;"><a href="#dev--development" aria-label="dev  development permalink" class="header-link-class before"><svg aria-hidden="true" height="20" version="1.1" viewBox="0 0 16 16" width="20"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>dev / development</h4>
<ul>
<li>Type: Boolean</li>
<li>Default: false</li>
</ul>
<p>Display only the dependency tree for packages in <code class="language-text">devDependencies</code>.</p>
...
<p>When "dev" or "development", is an alias to <code class="language-text">dev</code>.</p>
<p>When "prod" or "production", is an alias to <code class="language-text">production</code>.</p>
