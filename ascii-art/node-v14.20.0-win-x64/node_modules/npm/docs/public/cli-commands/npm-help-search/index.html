...
<p>If the argument to <code class="language-text">npm help</code> is not a known help topic, then it will
call <code class="language-text">help-search</code>.  It is rarely if ever necessary to call this
command directly.</p>
