...
the <code class="language-text">help-search</code> command to find a match.  Note that, if <code class="language-text">help-search</code>
finds a single subject, then it will run <code class="language-text">help</code> on that topic, so unique
