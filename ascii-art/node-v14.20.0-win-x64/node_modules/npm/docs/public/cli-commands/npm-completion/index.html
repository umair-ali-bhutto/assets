...
everywhere:</p>
<div class="gatsby-highlight" data-language="bash"><pre class="language-bash"><code class="language-bash"><span class="token function">npm</span> completion <span class="token operator">>></span> ~/.bashrc
<span class="token function">npm</span> completion <span class="token operator">>></span> ~/.zshrc</code></pre></div>
<p>You may of course also pipe the output of <code class="language-text">npm completion</code> to a file
such as <code class="language-text">/usr/local/etc/bash_completion.d/npm</code> or
<code class="language-text">/etc/bash_completion.d/npm</code> if you have a system that will read
that file for you.</p>
<p>When <code class="language-text">COMP_CWORD</code>, <code class="language-text">COMP_LINE</code>, and <code class="language-text">COMP_POINT</code> are defined in the
environment, <code class="language-text">npm completion</code> acts in "plumbing mode", and outputs
